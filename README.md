# Домашнее задание к занятию "`8.1 Git`" - `Коротков Андрей`
---
...
Ссылка на [коммит](https://github.com/aniljich/8.1_Git/commit/31fb052aaeccf9ffe6983ef701250afd1d455fb2)
...
Ссылка на [коммит](https://github.com/aniljich/8.1_Git/commit/05e4096ee1e6ebd9877bf3ea77171aae42b43ce9)
...
[Граф коммитов](https://github.com/aniljich/8.1_Git/network)
